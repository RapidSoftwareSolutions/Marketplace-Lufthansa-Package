...
$app->post('/api/Lufthansa/getAllCargoFlights', function ($request, $response) {
    ...
    $requiredParams = ['accessToken'=>'accessToken','origin'=>'origin','destination'=>'destination','fromDate'=>'fromDate'];
    $optionalParams = ['productCode'=>'productCode'];
    $bodyParams = [
