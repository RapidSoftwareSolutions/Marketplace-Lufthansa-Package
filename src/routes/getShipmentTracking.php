...
$app->post('/api/Lufthansa/getShipmentTracking', function ($request, $response) {
    ...
    $query_str = "https://api.lufthansa.com/v1/cargo/shipmentTracking/{$data['aWBPrefix']}-{$data['aWBNumber']}";
